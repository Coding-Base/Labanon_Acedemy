    ...
    <div className="min-h-screen bg-gray-50  custom-scrollbar">
      ...
      <div className="bg-white  border-b border-gray-200  sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <button
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 text-gray-600  hover:text-yellow-700 :text-yellow-500 transition-colors"
          >
            ...
            <div className="lg:col-span-1 order-1 lg:order-2">
              <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-video lg:aspect-auto lg:h-full">
                ...
                <div className="absolute bottom-4 left-4">
                  <div className="bg-white/90 /80 backdrop-blur-md text-green-800  text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider shadow-sm">
                    Course Preview
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                <div className="p-6">
                  ...
                  <div className="space-y-3">
                    {showPayment && Number(course.price) > 0 ? (
                      <PaymentCheckout
                        itemId={course.id}
                        itemType="course"
                        amount={course.price}
