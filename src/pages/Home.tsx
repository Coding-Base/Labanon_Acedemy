...
import flyerImage from './online.png'; // Imported the flyer image
import whitelogo from './labanon.png'
import seunSponsor from '../components/SeunP Media.png'
...
export default function Home() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // No longer needed - scroll handling is in Navbar
    };
