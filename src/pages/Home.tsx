...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {mobileMenuOpen && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -10 }}
              className="md:hidden bg-white border-t mt-4 rounded-xl shadow-xl p-4"
            >
              <nav className="space-y-4">
                ...
                <div className="pt-4 border-t">
                  <motion.div whileHover={{ x: 5 }}>
                    <Link
                      to="/login"
                      className="block px-4 py-3 text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-lg font-medium transition-colors mb-2"
                      onClick={() => setMobileMenuOpen(false)}
                    >
                      Sign In
                    </Link>
      ...
      {/* Hero Section */}
      <section ref={heroSectionRef} className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden">
              ...
              >
                <div className="relative flex items-center bg-white rounded-2xl shadow-xl p-2">
                  ...
                  <input
                    ...
                    placeholder="Search for courses, tutors, or exam topics..."
                    className="w-full pl-12 pr-4 py-4 text-gray-800 placeholder-gray-500 bg-transparent outline-none rounded-xl"
                  />
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="ml-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-semibold hover:shadow-lg transition-shadow"
                  >
                    Search
                  </motion.button>
                </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                <motion.div
                  ...
                  transition={{ duration: 0.6 }}
                  className="w-14 h-14 bg-gradient-to-br from-blue-500 to-purple-500 rounded-2xl flex items-center justify-center mb-6"
                >
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <motion.p
                  ...
                  className="text-gray-200 text-lg italic mb-8"
                >
                  "{testimonial.text}"
                </motion.p>
                ...
                <div className="flex items-center">
                  <motion.div
                    whileHover={{ scale: 1.1 }}
                    className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full flex items-center justify-center overflow-hidden"
                  >
                    <img
      ...
      >
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mb-8"
          >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Link
                to="/register"
                className="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-semibold text-lg hover:shadow-2xl hover:shadow-blue-500/30 transition-all duration-300 block"
              >
                Create Free Account
              </Link>
            </motion.div>
            ...
            >
              <Link
                to="/marketplace"
                className="px-8 py-4 bg-white text-gray-900 border-2 border-gray-200 rounded-xl font-semibold text-lg hover:border-blue-500 hover:text-blue-600 transition-all duration-300 block"
              >
                Browse Courses
              </Link>
            </motion.div>
