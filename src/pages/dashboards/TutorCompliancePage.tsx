    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          {showForm && (
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <ComplianceForm entityType="tutor" />
            </div>
          )}
        ...
        <aside className="bg-blue-50 p-6 rounded-lg border border-blue-100">
          ...
          <p className="text-sm text-blue-800">Download the official legal document, sign and upload supporting documents via the request form. Admin will review and approve or reject your verification.</p>
        </aside>
      </div>
    </div>
  )
